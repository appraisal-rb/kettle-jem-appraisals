...
Gem::Specification.new do |spec|
  ...
  spec.homepage = "https://github.com/appraisal-rb/kettle-jem-appraisals"
  ...
  spec.metadata["mailing_list_uri"] = "https://www.rubyforum.org/tag/appraisal-rb"
  ...
  spec.add_development_dependency("kettle-dev", "~> 3.1", ">= 3.1.0")             # ruby >= 4.0.0
  ...
  spec.add_development_dependency("kettle-test", "~> 2.0", ">= 2.0.22")            # ruby >= 4.0.0
